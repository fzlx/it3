 ...
 */
package com.it313.big.modules.gen.util;
...
import com.it313.big.common.mapper.JaxbMapper;
import com.it313.big.common.utils.DateUtils;
import com.it313.big.common.utils.FileUtils;
import com.it313.big.common.utils.FreeMarkers;
import com.it313.big.common.utils.StringUtils;
import com.it313.big.modules.gen.entity.GenCategory;
...
import com.it313.big.modules.sys.entity.Area;
...
//		}
	...
	public static Map<String, Object> getDataModel(GenScheme genScheme){
		...
		model.put("bigCpTp", "${bigCpTp}");
		model.put("bigCommonTp", "${bigCommonTp}");
		return model;
	}
	 ...
	 * @return
	 */
	public static String generateToFile(GenTemplate tpl, Map<String, Object> model, boolean isReplaceFile,GenScheme genScheme){

		// 获取生成文件
		String fileName = genScheme.getItemName()+File.separator
