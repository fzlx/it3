    ...
    <div class="middle-box text-center loginscreen  animated fadeInDown">
        <div>
            <div style="margin-bottom: 10px;">
                <h1 class="logo-name"><img src="${ctxStatic}/logo/logo144.png"/></h1>
            </div>
            <h3>欢迎使用 e联盟平台</h3>
            <form class="m-t" role="form" action="${ctx}/login" method="post">
                ...
                <p class="text-muted text-center"> <a href="javascript:void(0);"><small>忘记密码了？</small></a> | <a href="javascript:void(0);">爱玖信息科技</a></p>
            </form>
        </div>
    </div>
