...
<body class="gray-bg">
	...
	<script src="${ctxStatic}/Hplus-v.4.1.0/js/plugins/echarts/echarts.min.js"></script>
	...
	<script type="text/javascript">
		...
		$('.search-hide').click(function(){
			var _this = $(this),
				searchwrap = _this.data('searchwrap'),
				contentwrap = _this.data('contentwrap');
			$(contentwrap).removeClass('col-sm-9').addClass('col-sm-12');
			$(searchwrap).toggleClass('hide');
			$(contentwrap).find('.search-show').show();
		});
		...
		$('.search-show').click(function(){
			var _this = $(this),
				searchwrap = _this.data('searchwrap'),
				contentwrap = _this.data('contentwrap');
			$(contentwrap).removeClass('col-sm-12').addClass('col-sm-9');
			$(searchwrap).toggleClass('hide');
			$(contentwrap).find('.search-show').hide();
		});
	</script>
</body>
</html>