...
(function($) { 
    ...
    $.printPreview = {
        loadPrintPreview: function() {
            ...
            var print_frame = $('<iframe id="print-modal-content" scrolling="no" border="0" src="'+API.url.printUrl+'" frameborder="0" name="print-frame" onLoad="iFrameHeight(\'print-modal-content\')"/>');
...
//            print_frame.height($('body', print_frame.contents())[0].scrollHeight);
            ...
            $('a', print_controls).bind('click', function(e) {
                ...
                if ($(this).hasClass('print')) { 
                	...
                	var currentWindow = window.frames['print-modal-content'];
                	if(currentWindow.contentWindow==void(0)){
                		currentWindow.focus();
                		currentWindow.print();
                	}else{
                		currentWindow.contentWindow.print();
                	}
                }
