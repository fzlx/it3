...
<head>
	...
	<%@include file="/WEB-INF/views/include/tagIconview.jsp" %>
	<style>
		body{
			margin: 0 20px;
		}
	    #font-ico-part{line-height:34px;font-size:14px}
	    #font-ico-part i{width:50px;float:left;text-align:center;line-height:34px;}
	    #font-ico-part .alert-warning i{width:50px;float:left;text-align:center;line-height:23px;}
    ...
    <script type="text/javascript">
	    $(document).ready(function(){
	    	$("#font-ico-part .fa-hover").click(function(){
	    		$("#font-ico-part .fa-hover").removeClass("active");
	    		$(this).addClass("active");
	    		$("#icon").val("fa-"+$(this).text().trim());
	    	});
	    	$("#font-ico-part .fa-hover").each(function(){
	    		if ($(this).text()=="${value}"){
	    			$(this).click();
	    		}
	    	});
	    	$("#font-ico-part .fa-hover").dblclick(function(){
	    		parent.$(".layui-layer-btn").find("a[class='layui-layer-btn0']").trigger("click");
	    	});
	    });
    </script>
</head>
...
<section>
    ...
    <div class="row fontawesome-icon-list">
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-automobile"></i> automobile </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-bank"></i> bank </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-bar-chart"></i> bar-chart</div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-bar-chart-o"></i> bar-chart-o </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-battery-0"></i> battery-0 </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-battery-1"></i> battery-1 </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-battery-2"></i> battery-2 </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-battery-3"></i> battery-3 </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-battery-4"></i> battery-4 </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-bluetooth"></i> bluetooth</div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-bluetooth-b"></i> bluetooth-b</div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-cab"></i> cab </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-close"></i> close </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-dashboard"></i> dashboard </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-edit"></i> edit </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-feed"></i> feed </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-movie-o"></i> file-movie-o </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-pdf-o"></i> file-pdf-o</div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-photo-o"></i> file-photo-o </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-picture-o"></i> file-picture-o </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-powerpoint-o"></i> file-powerpoint-o</div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-sound-o"></i> file-sound-o </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-zip-o"></i> file-zip-o </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-flash"></i> flash </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-gear"></i> gear </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-gears"></i> gears </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-group"></i> group </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-hand-grab-o"></i> hand-grab-o </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-hand-stop-o"></i> hand-stop-o </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-hashtag"></i> hashtag</div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-hotel"></i> hotel </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-hourglass"></i> hourglass</div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-hourglass-1"></i> hourglass-1 </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-hourglass-2"></i> hourglass-2 </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-hourglass-3"></i> hourglass-3 </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-image"></i> image </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-institution"></i> institution </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-legal"></i> legal </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-life-bouy"></i> life-bouy </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-life-buoy"></i> life-buoy </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-life-ring"></i> life-ring</div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-life-saver"></i> life-saver </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-mail-forward"></i> mail-forward </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-mail-reply"></i> mail-reply </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-mail-reply-all"></i> mail-reply-all </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-mobile-phone"></i> mobile-phone </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-mortar-board"></i> mortar-board </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-navicon"></i> navicon </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-percent"></i> percent</div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-photo"></i> photo </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-remove"></i> remove </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-reorder"></i> reorder </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-send"></i> send </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-send-o"></i> send-o </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-shopping-bag"></i> shopping-bag</div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-shopping-basket"></i> shopping-basket</div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-soccer-ball-o"></i> soccer-ball-o </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-sort-down"></i> sort-down </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-sort-up"></i> sort-up </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-star-half-empty"></i> star-half-empty </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-star-half-full"></i> star-half-full </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-support"></i> support </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-toggle-down"></i> toggle-down </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-toggle-left"></i> toggle-left </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-toggle-right"></i> toggle-right </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-toggle-up"></i> toggle-up </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-tv"></i> tv </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-unsorted"></i> unsorted </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-warning"></i> warning </div>
...
<section>
    ...
    <div class="row fontawesome-icon-list">
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-intersex"></i> intersex </div>
...
<section>
    <h2 class="page-header">文件类型的图标</h2>
    <div class="row fontawesome-icon-list">
...
<section>
    <h2 class="page-header">微调控制项的图标</h2>
    <div class="row fontawesome-icon-list">
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-circle-o-notch"></i> circle-o-notch</div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-cog"></i> cog</div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-gear"></i> gear </div>
...
<section>
    <h2 class="page-header">表单控件的图标</h2>
    <div class="row fontawesome-icon-list">
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-check-square"></i> check-square</div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-check-square-o"></i> check-square-o</div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-circle"></i> circle</div>
...
<section>
    ...
    <div class="row fontawesome-icon-list">
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-credit-card"></i> credit-card</div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-credit-card-alt"></i> credit-card-alt</div>
...
<section id="currency">
    <h2 class="page-header">货币的图标</h2>
    <div class="row fontawesome-icon-list">
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-bitcoin"></i> bitcoin </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-btc"></i> btc</div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-cny"></i> cny </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-dollar"></i> dollar </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-eur"></i> eur</div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-euro"></i> euro </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-money"></i> money</div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-rmb"></i> rmb </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-rouble"></i> rouble </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-rub"></i> rub</div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-ruble"></i> ruble </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-rupee"></i> rupee </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-shekel"></i> shekel </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-sheqel"></i> sheqel </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-try"></i> try</div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-turkish-lira"></i> turkish-lira </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-usd"></i> usd</div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-won"></i> won </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-yen"></i> yen </div>
    </div>
</section>
<section>
    ...
    <div class="row fontawesome-icon-list">
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-chain"></i> chain </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-copy"></i> copy </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-cut"></i> cut </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-dedent"></i> dedent </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-eraser"></i> eraser</div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file"></i> file</div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-o"></i> file-o</div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-file-text"></i> file-text</div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-paste"></i> paste </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-repeat"></i> repeat</div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-rotate-left"></i> rotate-left </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-rotate-right"></i> rotate-right </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-save"></i> save </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-unlink"></i> unlink </div>
    </div>
</section>
<section>
    <h2 class="page-header">定向图标</h2>
    <div class="row fontawesome-icon-list">
...
<section>
    ...
    <div class="row fontawesome-icon-list">
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-pause-circle"></i> pause-circle</div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-pause-circle-o"></i> pause-circle-o</div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-stop-circle"></i> stop-circle</div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-stop-circle-o"></i> stop-circle-o</div>
...
<section>
    ...
    <div class="row fontawesome-icon-list margin-bottom-lg">
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-codiepie"></i> codiepie</div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-edge"></i> edge</div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-facebook-f"></i> facebook-f </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-fort-awesome"></i> fort-awesome</div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-ge"></i> ge </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-gittip"></i> gittip </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-mixcloud"></i> mixcloud</div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-modx"></i> modx</div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-product-hunt"></i> product-hunt</div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-qq"></i> qq</div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-ra"></i> ra </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-reddit-alien"></i> reddit-alien</div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-scribd"></i> scribd</div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-usb"></i> usb</div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-wechat"></i> wechat </div>
        ...
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-y-combinator-square"></i> y-combinator-square </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-yahoo"></i> yahoo</div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-yc"></i> yc </div>
        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-yc-square"></i> yc-square </div>
